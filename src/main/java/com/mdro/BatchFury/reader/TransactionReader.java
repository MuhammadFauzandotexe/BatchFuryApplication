...
@Component("transactionReaderMultiThread")
public class TransactionReader {
    ...
    /**
     * Basic Cursor Reader untuk single-threaded processing
     */
    @Bean
    public JdbcCursorItemReader<Transaction> transactionCursorReader() {
        return new JdbcCursorItemReaderBuilder<Transaction>()
                .name("transactionCursorReader")
    ...
    public JdbcPagingItemReader<Transaction> partitionedTransactionItemReader(
            ...
            @Value("${batch.chunk-size:500}") int chunkSize) throws Exception {
